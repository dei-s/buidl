var Formatting = (function(){
	...
	function formatTimestamp(timestamp, dateOnly, isAbsoluteTime, filter) {
		var date;
...
(function () {
	...
	angular
		...
		.service('formattingService', ['$filter', function ($filter) {
			this.formatTimestamp = function (timestamp, dateOnly, isAbsoluteTime) {
				return Formatting.formatTimestamp(timestamp, dateOnly, isAbsoluteTime, $filter);
			};
		}]);
})();
